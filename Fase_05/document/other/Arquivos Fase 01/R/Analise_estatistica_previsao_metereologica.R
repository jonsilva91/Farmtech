...
# Converter dados de produtividade para numérico
dados <- dados %>% mutate(produtividade = as.numeric(produtividade))

# Filtrar dados por cultura
...
# Calcular media de insumos para soja
...
#Calcular media de insumos para milho
...
# media de insumos aplicados na cultura
